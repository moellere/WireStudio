...
const boards: BoardSummary[] = [
  { id: "esp32-devkitc-v4", name: "ESP32-DevKitC-V4", mcu: "esp32", chip_variant: "esp32", framework: "arduino", platformio_board: "esp32dev", flash_size_mb: 4, rail_names: ["5V", "3V3", "GND"], image: null },
  { id: "nodemcu-32s",      name: "NodeMCU-32S",      mcu: "esp32", chip_variant: "esp32", framework: "arduino", platformio_board: "nodemcu-32s", flash_size_mb: 4, rail_names: ["5V", "3V3", "GND"], image: null },
  { id: "ttgo-lora32-v1",   name: "TTGO LoRa32 V1",   mcu: "esp32", chip_variant: "esp32", framework: "arduino", platformio_board: "ttgo-lora32-v1", flash_size_mb: 4, rail_names: ["5V", "3V3", "GND"], image: null },
  { id: "wemos-d1-mini",    name: "WeMos D1 Mini",    mcu: "esp8266", chip_variant: "esp8266", framework: "arduino", platformio_board: "d1_mini", flash_size_mb: 4, rail_names: ["5V", "3V3", "GND"], image: null },
  { id: "esp01_1m",         name: "ESP-01S 1MB",      mcu: "esp8266", chip_variant: "esp8266", framework: "arduino", platformio_board: "esp01_1m", flash_size_mb: 1, rail_names: ["5V", "3V3", "GND"], image: null },
];
